      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        {orders === undefined ? (
          ...
          <Card className="p-12 text-center bg-white rounded-2xl shadow-md">
            ...
            <p className="text-[#1E1012]/50 mb-6">
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <span className="font-display font-bold text-lg text-[#1E1012]">
                          {order.orderNumber}
                        </span>
                        <span
                      ...
                      <p className="text-[#1E1012]/50 text-sm mb-3">
                        {orderDate}
                      </p>
                    ...
                    <div className="text-right">
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        className="mt-3 rounded-full border-[#1E1012]/20 text-[#1E1012] hover:border-[#7C3AED] hover:text-[#7C3AED]"
                      >
                        Ver detalles
                      </Button>
                    </div>
